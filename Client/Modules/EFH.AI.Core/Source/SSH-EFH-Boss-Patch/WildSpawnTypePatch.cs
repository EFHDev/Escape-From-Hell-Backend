...
namespace SSH_EFH_Boss_Patch
{
    public static class WildSpawnTypePatch
    {
        ...
        public static uint femalepmcValue = 0x70000020;
        ...
        public static void Patch(ref AssemblyDefinition assembly)
        {
            ...
            var femalepmc = new FieldDefinition("femalepmc", FieldAttributes.Public | FieldAttributes.Static | FieldAttributes.Literal | FieldAttributes.HasDefault, botEnums)
            { Constant = femalepmcValue };
            botEnums.Fields.Add(femalepmc);
