...
class ProfileServer {
   ...
   */
   ...
   initializeProfile(sessionID) {
    if (global._database.gameplayConfig.trading.fleaLock) {
        global._database.globals.config.RagFair.minUserLevel = 1
    }
  ...
  loadProfileFromDisk(sessionID) {
    ...
    logger.logSuccess(`May god have mercy on you. You'll need it.`);
  }
