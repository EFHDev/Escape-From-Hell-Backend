...
class SSHFigure
{
    ...
    static onLoadMod()
    {
        SSHFigure.doTheManualCreationThingy(db, modPath);
		SSHFigure.traderFunctionForOrganizationsSake(ragfair, db);
		SSHFigure.addToMastery("efh_ssh_barter",4);
	}
...
//	}	
	...
	static addToMastery(weapon_id, mastery_index)
	{
        ...
        Logger.info(efhlogo + " Loaded SSH Figure")
	}
	
}

module.exports = SSHFigure;
